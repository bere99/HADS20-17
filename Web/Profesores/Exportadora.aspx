<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Exportadora.aspx.vb" Inherits="Web.Exportadora" %>
...
<body>
    <form id="form1" runat="server">
        <div style="height: 716px">
            ...
            <br />
            <asp:HyperLink ID="atras" runat="server" NavigateUrl="~/Profesores/Profesor.aspx">Atrás</asp:HyperLink>
            <br />
            <br />

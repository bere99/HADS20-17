<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="InsertarTareas.aspx.vb" Inherits="Web.WebForm1" %>
...
<body>
    <form id="form1" runat="server">
        <div style="height: 576px">
            ...
            <br />
            <asp:HyperLink ID="VerTareas" runat="server" NavigateUrl="~/Profesores/TareasProfesor.aspx">Ver Tareas</asp:HyperLink>
        </div>
    </form>
</body>
</html>

<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="InstanciarTarea.aspx.vb" Inherits="Web.InstanciarTarea" %>
...
<body>
    <form id="form1" runat="server">
        <div style="margin-left: 40px">
            ...
            <br />
            <asp:HyperLink ID="paganterior" runat="server" NavigateUrl="~/Alumnos/TareasAlumno.aspx">Página anterior</asp:HyperLink>
            <br />
        </div>
    </form>
</body>

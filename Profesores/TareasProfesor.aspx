<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TareasProfesor.aspx.vb" Inherits="Profesores.TareasProfesor" %>
...
<body style="height: 621px">
    <form id="form1" runat="server">
        <div style="height: 639px">
            ...
            <br />
            <br />
            <asp:GridView ID="GridView" runat="server" AutoGenerateColumns="False" BackColor="LightGoldenrodYellow" BorderColor="Tan" BorderWidth="1px" CellPadding="2" DataKeyNames="Codigo" DataSourceID="Mostrador" GridLines="None" AllowSorting="True" ForeColor="Black">

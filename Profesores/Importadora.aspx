<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Importadora.aspx.vb" Inherits="Profesores.Importadora" %>
...
<body style="height: 702px">
    <form id="form1" runat="server">
        <div id="m" style="height: 694px">
            ...
            <br />
            <br />
            <asp:HyperLink ID="menu" runat="server" NavigateUrl="~/Profesor.aspx">Atrás</asp:HyperLink>
            <br />
            <asp:Label ID="ibi" runat="server" Text="ibiCorructText"></asp:Label>
        </div>
    </form>
</body>
</html>
